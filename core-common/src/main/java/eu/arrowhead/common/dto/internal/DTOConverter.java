...
import eu.arrowhead.api.eventhandler.model.EventDTO;
import eu.arrowhead.api.eventhandler.model.EventPublishRequestDTO;
import eu.arrowhead.api.eventhandler.model.EventTypeResponseDTO;
...
public class DTOConverter {
    ...
    public static ServiceDefinitionResponseDTO convertServiceDefinitionToServiceDefinitionResponseDTO(final ServiceDefinition serviceDefinition) {
        ...
        return new ServiceDefinitionResponseDTO(serviceDefinition.getId(), serviceDefinition.getServiceDefinition(),
                                                Utilities.convertZonedDateTimeToUTCString(serviceDefinition.getCreatedAt()),
                                                Utilities.convertZonedDateTimeToUTCString(serviceDefinition.getUpdatedAt()));
    }

    //-------------------------------------------------------------------------------------------------
    public static ServiceDefinitionsListResponseDTO convertServiceDefinitionsListToServiceDefinitionListResponseDTO(
            final Page<ServiceDefinition> serviceDefinitions) {
    ...
    //-------------------------------------------------------------------------------------------------
    public static ServiceRegistryListResponseDTO convertServiceRegistryListToServiceRegistryListResponseDTO(
            final Page<ServiceRegistry> serviceRegistryEntries) {
    ...
    public static ServiceRegistryGroupedResponseDTO convertServiceRegistryDataToServiceRegistryGroupedResponseDTO(
            final Iterable<ServiceDefinition> serviceDefinitionEntries,
        ...
        for (final ServiceRegistry srEntry : serviceRegistryEntries) {
            ...
            if (servicesBySystemId.containsKey(systemId)) {
                ...
                final ServicesGroupedBySystemsResponseDTO dto = new ServicesGroupedBySystemsResponseDTO(systemId, systemName, systemAddress, systemPort,
                                                                                                        new ArrayList<>());
            ...
            if (servicesByServiceDefinition.containsKey(serviceDefinitionId)) {
                ...
                final ServicesGroupedByServiceDefinitionResponseDTO dto = new ServicesGroupedByServiceDefinitionResponseDTO(serviceDefinitionId,
                                                                                                                            serviceDefinition,
                                                                                                                            new ArrayList<>());
        ...
        final AutoCompleteDataResponseDTO autoCompleteDataResponseDTO = new AutoCompleteDataResponseDTO(servicesForAutoComplete, systemsForAutoComplete,
                                                                                                        interfacesForAutoComplete);

        return new ServiceRegistryGroupedResponseDTO(servicesGroupedBySystemsResponseDTOList, servicesGroupedByServiceDefinitionResponseDTOList,
    ...
    public static AuthorizationIntraCloudResponseDTO convertAuthorizationIntraCloudToAuthorizationIntraCloudResponseDTO(final AuthorizationIntraCloud entry) {
        ...
        return new AuthorizationIntraCloudResponseDTO(entry.getId(), convertSystemToSystemResponseDTO(entry.getConsumerSystem()),
                                                      convertSystemToSystemResponseDTO(entry.getProviderSystem()),
    ...
    //-------------------------------------------------------------------------------------------------
    public static AuthorizationIntraCloudListResponseDTO convertAuthorizationIntraCloudListToAuthorizationIntraCloudListResponseDTO(
            final Page<AuthorizationIntraCloud> entries) {
    ...
    public static CloudResponseDTO convertCloudToCloudResponseDTO(final Cloud entity) {
        ...
        return new CloudResponseDTO(entity.getId(), entity.getOperator(), entity.getName(), entity.getSecure(), entity.getNeighbor(), entity.getOwnCloud(),
    ...
    public static CloudWithRelaysResponseDTO convertCloudToCloudWithRelaysResponseDTO(final Cloud cloud) {
        ...
        return new CloudWithRelaysResponseDTO(cloudResponseDTO.getId(), cloudResponseDTO.getOperator(), cloudResponseDTO.getName(),
                                              cloudResponseDTO.getSecure(),
    ...
    //-------------------------------------------------------------------------------------------------
    public static AuthorizationInterCloudListResponseDTO convertAuthorizationInterCloudListToAuthorizationInterCloudListResponseDTO(
            final Page<AuthorizationInterCloud> entries) {
    ...
    public static AuthorizationInterCloudResponseDTO convertAuthorizationInterCloudToAuthorizationInterCloudResponseDTO(final AuthorizationInterCloud entity) {
        ...
        return new AuthorizationInterCloudResponseDTO(entity.getId(), convertCloudToCloudResponseDTO(entity.getCloud()),
    ...
    public static OrchestratorStoreResponseDTO convertOrchestratorStoreToOrchestratorStoreResponseDTO(final OrchestratorStore entity,
                                                                                                      final SystemResponseDTO providerSystem,
        ...
        return new OrchestratorStoreResponseDTO(entity.getId(), convertServiceDefinitionToServiceDefinitionResponseDTO(entity.getServiceDefinition()),
                                                ...
                                                convertServiceInterfaceToServiceInterfaceResponseDTO(entity.getServiceInterface()), entity.getPriority(),
    ...
    public static PreferredProviderDataDTO convertForeignOrchestratorStoreResponseDTOToPreferredProviderDataDTO(
            final OrchestratorStoreResponseDTO orchestratorStoreResponseDTO) {
        ...
        final SystemRequestDTO providerSystemRequestDTO = DTOConverter
                .convertSystemResponseDTOToSystemRequestDTO(orchestratorStoreResponseDTO.getProviderSystem());
    ...
    public static SubscriptionResponseDTO convertSubscriptionToSubscriptionResponseDTO(final Subscription subscription) {
        ...
        return new SubscriptionResponseDTO(subscription.getId(), convertEventTypeToEventTypeResponseDTO(subscription.getEventType()),
                                           ...
                                           Utilities.text2Map(subscription.getFilterMetaData()), subscription.getNotifyUri(),
                                           subscription.isMatchMetaData(), startDate, endDate, sources,
    ...
    public static EventDTO convertEventPublishRequestDTOToEventDTO(final EventPublishRequestDTO eventPublishRequestDTO) {
        ...
        return new EventDTO(eventPublishRequestDTO.getEventType(), eventPublishRequestDTO.getMetaData(), eventPublishRequestDTO.getPayload(),
    ...
    public static SystemResponseDTO convertForeignSystemToSystemResponseDTO(final ForeignSystem foreignSystem) {
        ...
        return new SystemResponseDTO(foreignSystem.getId(), foreignSystem.getSystemName(), foreignSystem.getAddress(), foreignSystem.getPort(),
                                     foreignSystem.getAuthenticationInfo(),
                                     Utilities.convertZonedDateTimeToUTCString(foreignSystem.getCreatedAt()),
                                     Utilities.convertZonedDateTimeToUTCString(foreignSystem.getUpdatedAt()));
    }
    ...
    public static PingMeasurementResponseDTO convertQoSIntraPingMeasurementToPingMeasurementResponseDTO(
        ...
        final QoSIntraMeasurementResponseDTO measurementResponseDTO = convertQoSIntraMeasurementToQoSIntraMeasurementResponseDTO(
                pingMeasurement.getMeasurement());
    ...
    //-------------------------------------------------------------------------------------------------
    private static List<ServiceInterfaceResponseDTO> collectInterfacesFromAuthorizationIntraCloud(
            final Set<AuthorizationIntraCloudInterfaceConnection> interfaceConnections) {
        final List<ServiceInterfaceResponseDTO> result = new ArrayList<>(interfaceConnections.size());
    ...
    //-------------------------------------------------------------------------------------------------
    private static List<ServiceInterfaceResponseDTO> collectInterfacesFromAuthorizationInterCloud(
            final Set<AuthorizationInterCloudInterfaceConnection> interfaceConnections) {
        final List<ServiceInterfaceResponseDTO> result = new ArrayList<>(interfaceConnections.size());
