...
//-------------------------------------------------------------------------------------------------
	...
	public static ArrowheadException createExceptionFromErrorMessageDTO(final ErrorMessageDTO dto) {
		...
		switch (dto.getExceptionType()) {
			case ARROWHEAD: case GENERIC:
				return new ArrowheadException(dto.getErrorMessage(), dto.getErrorCode(), dto.getOrigin());
			case AUTH:
				return new AuthException(dto.getErrorMessage(), dto.getErrorCode(), dto.getOrigin());
			case BAD_PAYLOAD:
				return new BadPayloadException(dto.getErrorMessage(), dto.getErrorCode(), dto.getOrigin());
			case INVALID_PARAMETER:
				return new InvalidParameterException(dto.getErrorMessage(), dto.getErrorCode(), dto.getOrigin());
			case DATA_NOT_FOUND:
				return new DataNotFoundException(dto.getErrorMessage(), dto.getErrorCode(), dto.getOrigin());
			case TIMEOUT:
				return new TimeoutException(dto.getErrorMessage(), dto.getErrorCode(), dto.getOrigin());
			case UNAVAILABLE:
				return new UnavailableServerException(dto.getErrorMessage(), dto.getErrorCode(), dto.getOrigin());
			default:
		...
		//-------------------------------------------------------------------------------------------------
	public static void throwExceptionFromErrorMessageDTO(final ErrorMessageDTO dto) {
		throw createExceptionFromErrorMessageDTO(dto);
    }
